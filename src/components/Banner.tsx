...
import prime from "../images/slider/prime.jpg";
import fashion from "../images/slider/fashion.jpg";
...
const Banner = () => {
  return (
    <div className="relative">
      ...
      >
        <div>
          <Image priority src={prime} alt="sliderImg" />
        </div>
        <div>
          <Image src={fashion} alt="sliderImg" />
        </div>
        <div>
